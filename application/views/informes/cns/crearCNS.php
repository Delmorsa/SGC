 ...
 * @Last Modified time: 2019-08-14 16:37:14
 */
?>
	...
	<section class="content">
		<div class="box box-danger">
			...
			<div class="box-body">
				<div>
					...
					<div class="row">
						...
						<div class="col-xs-2">
							<div class="form-group has-feedback">
								<label for="">Cantidad nitrito solicit.</label>
						...
						<div class="col-xs-2">
							<div class="form-group has-feedback">
								...
								<input autofocus="" autocomplete="off" type="text" id="kg" class="form-control" placeholder="cantidad Kg">
								<span class="fa fa-sort-alpha-desc form-control-feedback"></span>
							</div>
						</div>
						<div class="col-xs-2">
						...
						<div class="col-xs-2">
							<div class="form-group has-feedback">
								<label for=""> </label>
								<button id="btnAdd" class="btn btn-primary">Agregar <i class="fa fa-plus"></i></button>
							</div>
						</div>
						<div class="col-xs-2 col-sm-pull-1">
							<div class="form-group has-feedback">
								<label for=""> </label>
								<button id="btnDelete" class="btn btn-danger">Eliminar <i class="fa fa-trash"></i></button>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="box-footer">
				<p>21,336 gr de Sal Común + 1,362 gr Nitrito / 1 Batch (Total Sal Cura: 22,698 gr) <br>
